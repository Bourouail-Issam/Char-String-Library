...

{
    ...
    cout << "Number of words: " <<
        clsString::CountWords("Hello-_-World -_-") << endl;
    ...
    cout << "After inverting a : "
        << clsChar::InvertLetterCase('a') << endl;
    ...
    cout << "Capital Letters count : "
        << clsString::CountLetters("hello world !! .", clsString::CapitalLetters)
        << endl << endl;
    ...
    cout << "is letter u vowel? " << clsChar::IsVowel('a')
        << endl;
